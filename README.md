...
To host the app, see [Hosting-server-installation](docs/Hosting-server-installation.md).

To deploy the app to the hosting server, see [Deployment](docs/Deployment.md).
