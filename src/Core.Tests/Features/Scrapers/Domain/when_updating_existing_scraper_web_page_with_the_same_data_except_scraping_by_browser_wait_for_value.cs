...
[TestFixture]
public class when_updating_existing_scraper_web_page_with_the_same_data_except_scraping_by_browser_wait_for_value : BaseTest
{
    ...
    private void _BuildEntities()
    {
        _scraper = new ScraperBuilder()
            .WithWebPage(new ScraperWebPageArgs
            {
                ...
                Selector = ".selector",
                ScrapeHtmlAsRenderedByBrowser = true,
                ScrapingByBrowserWaitFor = ScrapingByBrowserWaitFor.Load,
                SelectText = false,
                Name = "url.com/page"
            })
            .Build();
