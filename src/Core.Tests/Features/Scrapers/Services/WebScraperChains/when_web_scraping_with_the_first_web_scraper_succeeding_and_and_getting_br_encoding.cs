...
[TestFixture]
public class when_web_scraping_with_the_first_web_scraper_succeeding_and_and_getting_br_encoding
{
        ...
        var httpClientFactory = new HttpClientFactoryBuilder()
            .WithRequestResponse(new HttpMessageRequestResponse(
                ...
                () =>
                {
                    ...
                    using (var deflateStream = new BrotliStream(ms, CompressionMode.Compress, leaveOpen: true))
                    {
                    ...
                    byteArrayContent.Headers.ContentEncoding.Add("br");
