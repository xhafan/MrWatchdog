...
[TestFixture]
public class when_getting_scraper_detail_web_page_turbo_frame : BaseDatabaseTest
{
    ...
    [Test]
    public async Task scraper_detail_web_page_turbo_frame_page_can_be_fetched()
    {
        ...
        response.Headers.Location.ToString().ShouldEndWith(
            $"/Account/Login?ReturnUrl=%2FScrapers%2FDetail%2FWebPage%2FWebPageTurboFrame%3FscraperId%3D{_scraper.Id}%26scraperWebPageId%3D{scraperWebPageId}");
    }
