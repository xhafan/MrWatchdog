...
public class when_completing_external_login : BaseDatabaseTest
{
    ...
    public async Task Context()
    {
        ...
        A.CallTo(() => urlHelper.IsLocalUrl("/Watchdogs/Alerts")).Returns(true);
        ...
        _actionResult = await _controller.CompleteExternalLoginCallback(returnUrl: "/Watchdogs/Alerts");
    }
    ...
    public void action_result_is_correct()
    {
        ...
        redirectResult.Url.ShouldBe("/Watchdogs/Alerts");
    }
