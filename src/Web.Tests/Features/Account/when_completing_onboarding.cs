...
public class when_completing_onboarding : BaseDatabaseTest
{
    ...
    public async Task Context()
    {
        ...
        _actionResult = await _controller.CompleteOnboarding(OnboardingIdentifiers.WatchdogsScrapingResults);
    } 

    [Test]
    public void command_is_sent_over_message_bus()
    {
        A.CallTo(() => _bus.Send(new CompleteOnboardingCommand(OnboardingIdentifiers.WatchdogsScrapingResults))).MustHaveHappenedOnceExactly();
    }
