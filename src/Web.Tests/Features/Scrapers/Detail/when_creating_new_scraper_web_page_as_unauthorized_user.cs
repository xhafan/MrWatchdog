...
[TestFixture]
public class when_creating_new_scraper_web_page_as_unauthorized_user : BaseDatabaseTest
{
    ...
    public async Task Context()
    {
        ...
        _actionResult = await _model.OnPostCreateScraperWebPage(_scraper.Id);
    }

    [Test]
    public void command_is_not_sent_over_message_bus()
    {
        A.CallTo(() => _bus.Send(new CreateScraperWebPageCommand(_scraper.Id))).MustNotHaveHappened();
    }
