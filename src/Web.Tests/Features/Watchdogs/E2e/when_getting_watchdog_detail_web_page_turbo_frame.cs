...
public class when_getting_watchdog_detail_web_page_turbo_frame : BaseDatabaseTest
{
    ...
    {
        var watchdogDetailUrl = WatchdogConstants.WatchdogDetailWebPageTurboFrameUrl
            .Replace(WatchdogConstants.WatchdogIdVariable, $"{_watchdog.Id}")
            .Replace(WatchdogConstants.WatchdogWebPageIdVariable, $"{_watchdog.WebPages.Single().Id}");
